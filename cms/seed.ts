  ...
  const orders = [
    {
      ...
      items: [
        { productId: productIds['ELEC-001'], quantity: 1, price: 89.99 },
        { productId: productIds['BOOK-001'], quantity: 1, price: 34.99 },
      ],
      totalAmount: 124.98,
    },
    {
      ...
      notes: '',
      items: [
        { productId: productIds['CLTH-001'], quantity: 2, price: 49.99 },
        { productId: productIds['CLTH-003'], quantity: 1, price: 95.00 },
      ],
      totalAmount: 194.98,
    },
    {
      ...
      notes: 'Leave at door.',
      items: [
        { productId: productIds['ELEC-002'], quantity: 1, price: 39.99 },
        { productId: productIds['ELEC-004'], quantity: 1, price: 59.99 },
        { productId: productIds['BOOK-002'], quantity: 1, price: 39.99 },
      ],
      totalAmount: 139.97,
    },
    {
      ...
      notes: '',
      items: [
        { productId: productIds['CLTH-002'], quantity: 1, price: 64.95 },
      ],
      totalAmount: 64.95,
    },
    {
      ...
      items: [
        { productId: productIds['ELEC-001'], quantity: 2, price: 89.99 },
      ],
      totalAmount: 179.98,
    },
  ];
